...
#OWNER ID
OWNER_ID = int(os.environ.get("OWNER_ID", "6752287005"))
...
FORCESUB_CHANNEL2 = int(os.environ.get("FORCESUB_CHANNEL2", "-1002101640705"))
...
#Short Url or Api
SHORT_URL = os.environ.get("SHORTNER_URL", "shortner.in")
